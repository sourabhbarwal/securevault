      ...
      <div className="flex min-h-screen">
        ...
        <main className="flex-1 ml-0 md:ml-72 p-8 md:p-12 relative z-10">
          ...
          <div className="flex flex-col gap-4">
            {/* Row Item 1 */}
            <div className="glass-row group bg-surface-container-low/40 rounded-2xl border border-white/5 p-5 flex items-center gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1">
                  <h3 className="font-headline font-bold text-lg text-on-surface">AWS Master Console</h3>
                ...
                <p className="text-on-surface-variant text-sm font-body">console.aws.amazon.com/iam/home</p>
              </div>
              <div className="hidden lg:block w-48">
                <p className="text-[10px] text-outline uppercase font-bold mb-1">Username</p>
                <p className="font-mono text-sm text-on-surface">admin_root_nexus</p>
              </div>
              <div className="hidden lg:block w-48">
                <p className="text-[10px] text-outline uppercase font-bold mb-1">Password</p>
                <div className="flex items-center gap-2">
                  <span className="text-on-surface tracking-widest">• • • • • • • •</span>
                  <span className="material-symbols-outlined text-outline text-lg cursor-pointer hover:text-primary" data-icon="visibility">visibility</span>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <button className="w-10 h-10 rounded-lg hover:bg-primary/10 hover:text-primary transition-colors flex items-center justify-center text-outline">
                  <span className="material-symbols-outlined" data-icon="content_copy">content_copy</span>
                </button>
                <button className="w-10 h-10 rounded-lg hover:bg-secondary/10 hover:text-secondary transition-colors flex items-center justify-center text-outline">
            ...
            {/* Row Item 2 */}
            <div className="glass-row group bg-surface-container-low/40 rounded-2xl border border-white/5 p-5 flex items-center gap-6">
              <div className="w-14 h-14 rounded-xl bg-tertiary-container/10 flex items-center justify-center border border-tertiary-container/20 shrink-0">
                <span className="material-symbols-outlined text-tertiary-container text-2xl" data-icon="currency_bitcoin">currency_bitcoin</span>
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1">
                  <h3 className="font-headline font-bold text-lg text-on-surface">Ledger Recovery Key</h3>
                ...
                <p className="text-on-surface-variant text-sm font-body">Offline Storage Phrase</p>
              </div>
              <div className="hidden lg:block w-48">
                <p className="text-[10px] text-outline uppercase font-bold mb-1">Identity</p>
                <p className="font-mono text-sm text-on-surface">Vault-7712</p>
              </div>
              <div className="hidden lg:block w-48">
                <p className="text-[10px] text-outline uppercase font-bold mb-1">Security</p>
                <div className="flex items-center gap-2">
                  <span className="text-tertiary-container text-xs font-bold flex items-center gap-1">
                    <span className="material-symbols-outlined text-sm" data-icon="verified_user">verified_user</span> 2FA ACTIVE
                  </span>
                </div>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="glass-row group bg-surface-container-low/40 rounded-2xl border border-white/5 p-5 flex items-center gap-6">
              <div className="w-14 h-14 rounded-xl bg-secondary/10 flex items-center justify-center border border-secondary/20 shrink-0">
                <span className="material-symbols-outlined text-secondary text-2xl" data-icon="mail">mail</span>
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1">
                  <h3 className="font-headline font-bold text-lg text-on-surface">ProtonMail Admin</h3>
                ...
                <p className="text-on-surface-variant text-sm font-body">mail.proton.me</p>
              </div>
              <div className="hidden lg:block w-48">
                <p className="text-[10px] text-outline uppercase font-bold mb-1">Email</p>
                <p className="font-mono text-sm text-on-surface">nexus@pm.me</p>
              </div>
              <div className="hidden lg:block w-48">
                <p className="text-[10px] text-outline uppercase font-bold mb-1">Strength</p>
                <div className="flex items-center gap-2">
                  <div className="flex gap-0.5">
                    <div className="w-4 h-1 rounded bg-primary"></div>
                    <div className="w-4 h-1 rounded bg-primary"></div>
                    <div className="w-4 h-1 rounded bg-primary"></div>
                    <div className="w-4 h-1 rounded bg-primary/20"></div>
                  </div>
                </div>
              </div>
              <div className="flex items-center gap-2">
            ...
            {/* Row Item 4 */}
            <div className="glass-row group bg-surface-container-low/40 rounded-2xl border border-white/5 p-5 flex items-center gap-6">
              <div className="w-14 h-14 rounded-xl bg-outline/10 flex items-center justify-center border border-outline/20 shrink-0">
                <span className="material-symbols-outlined text-outline text-2xl" data-icon="database">database</span>
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1">
                  <h3 className="font-headline font-bold text-lg text-on-surface">Production DB Key</h3>
                  <span className="px-2 py-0.5 rounded text-[10px] bg-secondary/10 text-secondary border border-secondary/20 font-bold uppercase tracking-wider">Work</span>
                </div>
                <p className="text-on-surface-variant text-sm font-body">PostgreSQL / Nexus-Cluster-01</p>
              </div>
              <div className="hidden lg:block w-48">
                <p className="text-[10px] text-outline uppercase font-bold mb-1">User</p>
                <p className="font-mono text-sm text-on-surface">db_admin_svc</p>
              </div>
              <div className="hidden lg:block w-48">
                <p className="text-[10px] text-outline uppercase font-bold mb-1">Expires</p>
                <p className="font-mono text-sm text-error font-bold italic">14 Days</p>
              </div>
              <div className="flex items-center gap-2">
                <button className="w-10 h-10 rounded-lg hover:bg-primary/10 hover:text-primary transition-colors flex items-center justify-center text-outline">
                  <span className="material-symbols-outlined" data-icon="content_copy">content_copy</span>
